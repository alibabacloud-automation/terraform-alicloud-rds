...
output "this_db_instance_id" {
  ...
  value       = module.sql_server.this_db_database_id
}
...
output "this_db_instance_type" {
  ...
  value       = module.sql_server.this_db_instance_type
}
output "this_db_instance_storage" {
  description = "Rds instance storage."
  value       = module.sql_server.this_db_instance_storage
}
output "this_db_instance_charge_type" {
  description = "Rds instance charge type."
  value       = module.sql_server.this_db_instance_charge_type
}
...
output "this_db_instance_period" {
  ...
  value       = module.sql_server.this_db_instance_period
}
...
output "this_db_database_description" {
  ...
  value       = module.sql_server.this_db_database_description
}
...
output "this_db_database_name" {
  description = "Rds database id."
  value       = module.sql_server.this_db_database_name
}
...
output "this_db_database_account_privilege" {
  ...
  value       = module.sql_server.this_db_database_account_privilege
}
