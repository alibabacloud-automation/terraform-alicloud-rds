...
output "this_db_instance_id" {
  ...
  value       = module.postgre_sql.this_db_database_id
}
...
output "this_db_instance_type" {
  ...
  value       = module.postgre_sql.this_db_instance_type
}
output "this_db_instance_storage" {
  description = "Rds instance storage."
  value       = module.postgre_sql.this_db_instance_storage
}
output "this_db_instance_charge_type" {
  description = "Rds instance charge type."
  value       = module.postgre_sql.this_db_instance_charge_type
}
...
output "this_db_instance_connection_ip_address" {
  ...
  value       = module.postgre_sql.this_db_instance_connection_ip_address
}
...
output "this_db_database_description" {
  ...
  value       = module.postgre_sql.this_db_database_description
}
...
output "this_db_database_name" {
  description = "Rds database id."
  value       = module.postgre_sql.this_db_database_name
}
...
output "this_db_database_account" {
  ...
  value       = module.postgre_sql.this_db_database_account
}
output "this_db_database_account_privilege" {
  description = "Rds database account privilege."
  value       = module.postgre_sql.this_db_database_account_privilege
}

output "this_db_database_account_type" {
  description = "Rds database account type."
  value       = module.postgre_sql.this_db_database_account_type
}
